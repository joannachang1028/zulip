...
from zerver.views.topic_title_improver import get_topic_title_suggestion
...
v1_api_and_json_patterns = [
    ...
    rest_path(
        "messages/recap",
        GET=(get_messages_recap, {"intentionally_undocumented"}),
    ),
    rest_path(
        "topic/suggest_title",
        GET=(get_topic_title_suggestion, {"intentionally_undocumented"}),
    ),
